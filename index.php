...
<body>
    ...
    <div class="jumbotron" id="jumbotron">
        ...
        <div id="div_metade">
            ...
            <a class="btn btn-outline-light btn-lg" href="cursos.html" role="button" id="botao">Conheça nosssos cursos</a>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg">
                <div class="card alunos" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Harik Lahurod</h5>
            ...
            <div class="col-lg">
                <div class="card alunos" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Hong Sato Kawashima</h5>
